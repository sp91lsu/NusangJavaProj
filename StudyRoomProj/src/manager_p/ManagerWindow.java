...
//		});
		...
		lblNewLabel_2.setFont(new Font("휴먼엑스포", Font.BOLD, 25));
		...
		lblNewLabel_3.setFont(new Font("휴먼엑스포", Font.BOLD, 25));
		...
		lblNewLabel_5.setFont(new Font("휴먼엑스포", Font.BOLD, 25));
		...
		lblNewLabel_2_1.setFont(new Font("휴먼엑스포", Font.BOLD, 25));
		...
		lblNewLabel_3_1.setFont(new Font("휴먼엑스포", Font.BOLD, 25));
		...
		lblNewLabel_5_1.setFont(new Font("휴먼엑스포", Font.BOLD, 25));
