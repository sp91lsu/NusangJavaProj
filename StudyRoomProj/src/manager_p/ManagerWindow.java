...
//		});
		...
		contentsAllMem = new String[][] { { "ª˛øˆΩ«", "2", "30000","ef" }, { "¿œπ›1", "3", "34003","ef" }, { "§∑§©§ß§ß", "4", "34534","ef" },
			{ "dfeb", "5", "234767" ,"ef"}};
		...
		contentsMemSearch = new String[][] { { "ª˛øˆΩ«", "2", "30000","ef" }, { "¿œπ›1", "3", "34003","ef" }, { "§∑§©§ß§ß", "4", "34534","ef" },
			{ "dfeb", "5", "234767" ,"ef"}};
...
//		pp=[∞°-Éâ§°]º∫[æ∆-üÁ§∑]  if(Pattern.matches(pp, ud.name/id/phone)) searchedUDs.add(ud);
		...
		if(packet.getClass() == SmResvRoomAck.class) {
			...
			System.out.println("rTimeDList ªÁ¿Ã¡Ó "+rTimeDList.size());
