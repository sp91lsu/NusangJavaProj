...
public class ManagerWindow extends JFrame implements Receivable {
	...
	private String[] headerMem = new String[] { "ÀÌ¸§", "ID", "ÈÞ´ëÆù¹øÈ£", "»ý³â¿ùÀÏ" };
...
//	        	pnl_SalesInquiry.setDateList();
		...
		// °ü¸® - ÀüÃ¼ ¹öÆ°
		JButton btnNewButton_1 = new JButton("ÀüÃ¼ È¸¿ø");
...
//		});
		...
		contentsAllMem = new String[][] { { "»þ¿ö½Ç", "2", "30000", "ef" }, { "ÀÏ¹Ý1", "3", "34003", "ef" },
				{ "¤·¤©¤§¤§", "4", "34534", "ef" }, { "dfeb", "5", "234767", "ef" } };
		...
		contentsMemSearch = new String[][] { { "»þ¿ö½Ç", "2", "30000", "ef" }, { "ÀÏ¹Ý1", "3", "34003", "ef" },
				{ "¤·¤©¤§¤§", "4", "34534", "ef" }, { "dfeb", "5", "234767", "ef" } };
		...
		table_6.setFont(new Font("»õ±¼¸²", Font.PLAIN, 25));
...
//		scrollPane_7.setViewportView(seating_Arrangement);
		...
		headerResvs = new String[] { "ÀÌ¿ë¼®", "¿¹¾àÀÚ", "¿¹¾à½Ã°£" };
		...
		table.getColumn("ÀÌ¿ë¼®").setPreferredWidth(100);
		table.getColumn("¿¹¾àÀÚ").setPreferredWidth(100);
		...
		tabbedPane.addTab("¸ÅÃâ Á¶È¸", pnl_SalesInquiry);

		tabbedPane.addTab("1:1 ¹®ÀÇ Ã¤ÆÃ", pnl_Chatting);

		System.out.println("ManagerWindow ÁØºñ¿Ï·á.");
	}
	...
	public void receive(PacketBase packet) {
		...
		if (packet.getClass() == SmAllMemListAck.class) {
			...
			System.out.println("ack »çÀÌÁî:" + ack.userList.size() + " contentsAllMem »çÀÌÁî:" + contentsAllMem.length);
...
>>>>>>> 2891dd3431b87264190b4630fd0d1bdb73756196
		...
		// ¿¹¾à°ü¸® ÆäÀÌÁö·Î ÀÌµ¿½Ã Àç°í ·ëÁ¤º¸ ¹Þ¾Æ¿À±â
		if (packet.getClass() == SmResvRoomAck.class) {
			SmResvRoomAck ack = (SmResvRoomAck) packet;
			rTimeDList = ack.rtd;

			System.out.println("rTimeDList »çÀÌÁî " + rTimeDList.size());
